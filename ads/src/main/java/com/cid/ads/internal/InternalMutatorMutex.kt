 ...
 */
/*internal class InternalAtomicReference<V>(var value: V) {
    fun get(): V = value
    ...
    fun compareAndSet(expect: V, newValue: V): Boolean{
        val answer = this.value == expect
        if (answer) this.value = newValue
        return answer
    }
}*/

private typealias InternalAtomicReference<V> = java.util.concurrent.atomic.AtomicReference<V>
