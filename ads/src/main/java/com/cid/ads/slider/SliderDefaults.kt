...
object SliderDefaults {
    ...
    @Composable
    fun colors(
        thumbColor: Color = AkaTheme.colorScheme.primary,
        activeTrackColor: Color = AkaTheme.colorScheme.primary,
        activeTickColor: Color = AkaTheme.colorScheme.secondaryContainer,
        inactiveTrackColor: Color = AkaTheme.colorScheme.secondaryContainer,
        inactiveTickColor: Color = AkaTheme.colorScheme.primary,
        labelTextColor: Color = AkaTheme.colorScheme.onSurface,
        labelContainerColor: Color = AkaTheme.colorScheme.surfaceContainerHighest,
        contentColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
    ): SliderColors =
        SliderColors(
