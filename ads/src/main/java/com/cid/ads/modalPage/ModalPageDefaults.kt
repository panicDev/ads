...
import com.cid.ads.topAppBar.TopAppBarColors
import com.cid.ads.topAppBar.TopAppBarDefaults
import com.cid.ads.topAppBar.TopAppBarSizes
...
object ModalPageDefaults {
    ...
    fun colors(
        ...
        dragHandleColor: Color = AkaTheme.colorScheme.outlineVariant,
    ...
    @Composable
    fun sizes(
        containerShape: CornerBasedShape = AkaTheme.shapes.shape20,
