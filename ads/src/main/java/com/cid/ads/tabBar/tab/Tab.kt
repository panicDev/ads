package com.cid.ads.tabBar.tab
...
import com.cid.ads.counter.Badge
import com.cid.ads.counter.Counter
...
import com.cid.ads.tabBar.TabBar
import com.cid.ads.tabBar.TabColors
import com.cid.ads.tabBar.TabSizes
import com.cid.ads.tabBar.tab.Orientation.HORIZONTAL
import com.cid.ads.tabBar.tab.Orientation.VERTICAL
    ...
    CompositionLocalProvider(
        ...
        Row(
            modifier = modifier
                ...
                .heightIn(min = 48.dp)
                .padding(
                    top = AkaTheme.spacing.size8,
                    bottom = AkaTheme.spacing.size8
                )
                .fillMaxWidth()
                .padding(horizontal = AkaTheme.spacing.size2),
            horizontalArrangement = Arrangement.spacedBy(
                AkaTheme.spacing.size4,
