...
import com.cid.ads.tabBar.scrollable.ScrollableTabBar
...
object TabBarDefaults {
    ...
    fun tabColors(
        ...
        activeContainerColor: Color = AkaTheme.colorScheme.surface,

        indicatorColor: Color = AkaTheme.colorScheme.primary,

        contentColor: Color = AkaTheme.colorScheme.onSurface,
        activeContentColor: Color = AkaTheme.colorScheme.primary,
    ...
    fun tabSizes(
        ...
        indicatorShape: Shape = AkaTheme.shapes.shape4.copy(
