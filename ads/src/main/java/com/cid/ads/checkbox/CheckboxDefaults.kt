...
import androidx.compose.ui.unit.dp
import com.cid.ads.checkbox.toggle.BOX_IN_DURATION
import com.cid.ads.checkbox.toggle.BOX_OUT_DURATION
import com.cid.ads.checkbox.toggle.CheckboxToggle
import com.cid.ads.checkbox.toggle.TriStateCheckboxToggle
...
object CheckboxDefaults {
    ...
    fun toggleColors(
        ...
        uncheckedBorderColor: Color = AkaTheme.colorScheme.outline,

        checkedBoxColor: Color = AkaTheme.colorScheme.primary,
        uncheckedBoxColor: Color = Color.Transparent,

        checkedCheckmarkColor: Color = AkaTheme.colorScheme.surface,
    ...
    fun colors(
        ...
        textColor: Color = AkaTheme.colorScheme.onSurface,
    ) = CheckboxColors(
    ...
    fun sizes(
        toggleSize: Dp = 24.dp,
        textStyle: TextStyle = AkaTheme.typography.labelLarge,
