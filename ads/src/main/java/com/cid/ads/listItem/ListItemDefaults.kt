...
import com.cid.ads.avatarAndImage.AvatarColors
import com.cid.ads.avatarAndImage.AvatarDefaults
import com.cid.ads.avatarAndImage.AvatarSizes
import com.cid.ads.avatarAndImage.ImageColors
import com.cid.ads.avatarAndImage.ImageDefaults
import com.cid.ads.avatarAndImage.ImageSizes
import com.cid.ads.button.ButtonColors
import com.cid.ads.button.ButtonDefaults
import com.cid.ads.button.ButtonSizes
import com.cid.ads.checkbox.CheckboxDefaults
import com.cid.ads.checkbox.CheckboxSizes
import com.cid.ads.checkbox.CheckboxToggleColors
import com.cid.ads.counter.CounterColors
import com.cid.ads.counter.CounterDefaults
import com.cid.ads.counter.CounterSizes
import com.cid.ads.divider.DividerDefaults
import com.cid.ads.divider.DividerSizes
...
import com.cid.ads.radioButton.RadioButtonDefaults
import com.cid.ads.radioButton.RadioButtonSizes
import com.cid.ads.radioButton.RadioButtonToggleColors
import com.cid.ads.switch.SwitchColors
import com.cid.ads.switch.SwitchDefaults
import com.cid.ads.switch.SwitchSizes
...
object ListItemDefaults {
    ...
    @Composable
    fun colors(
        leadingIconColor: Color = AkaTheme.colorScheme.primary,
        ...
        bodyColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        subheadColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        newLabelColor: Color = AkaTheme.colorScheme.onValid,
        newLabelContainerColor: Color = AkaTheme.colorScheme.valid,
        ...
        trailingSuffixColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        trailingSuffixBodyColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        trailingIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        dividerColor: Color = AkaTheme.colorScheme.outlineVariant
    ) = ListItemColors(
    ...
    fun sizes(
        ...
        bodyTextStyle: TextStyle = AkaTheme.typography.bodyMedium,
        subheadTextStyle: TextStyle = AkaTheme.typography.labelExtraSmall,
        newLabelTextStyle: TextStyle = AkaTheme.typography.labelSmall,
        newLabelShape: Shape = AkaTheme.shapes.shape6,
        ...
        trailingSuffixTextStyle: TextStyle = AkaTheme.typography.labelMedium,
        trailingSuffixBodyTextStyle: TextStyle = AkaTheme.typography.bodySmall,
