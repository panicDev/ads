...
object FabDefaults {
    ...
    @Composable
    fun primaryColors(
        backgroundColor: Color = AkaTheme.colorScheme.primaryContainer,
        content: Color = AkaTheme.colorScheme.onPrimaryContainer,
    ) = FabColors(
    ...
    @Composable
    fun secondaryColors(
        backgroundColor: Color = AkaTheme.colorScheme.secondaryContainer,
        content: Color = AkaTheme.colorScheme.onSecondaryContainer,
    ) = FabColors(
        backgroundColor = backgroundColor,
        contentColor = content
    )
    ...
    @Composable
    fun tertiaryColors(
        backgroundColor: Color = AkaTheme.colorScheme.tertiaryContainer,
        content: Color = AkaTheme.colorScheme.onTertiaryContainer
    ) = FabColors(
        backgroundColor = backgroundColor,
        contentColor = content
    )
    ...
    @Composable
    fun neutralColors(
        backgroundColor: Color = AkaTheme.colorScheme.surfaceContainerHighest,
        content: Color = AkaTheme.colorScheme.primary
    ) = FabColors(
        backgroundColor = backgroundColor,
        contentColor = content
    )
    ...
    fun smallSizes(
        ...
        cornerShape: Shape = AkaTheme.shapes.shape12
    ) = FabSizes(
        boxSize = boxSize,
        iconSizes = iconSizes,
        textStyle = AkaTheme.typography.labelLarge,
    ...
    fun defaultSizes(
        ...
        textStyle: TextStyle = AkaTheme.typography.buttonLarge,
        cornerShape: Shape = AkaTheme.shapes.shape16
    ) = FabSizes(
        boxSize = boxSize,
        iconSizes = iconSizes,
        textStyle = textStyle,
    ...
    @Composable
    fun elevation(
        defaultElevation: Dp = AkaTheme.elevation.elevation3,
        pressedElevation: Dp = AkaTheme.elevation.elevation3,
        focusedElevation: Dp = AkaTheme.elevation.elevation3,
        hoveredElevation: Dp = AkaTheme.elevation.elevation4,
    ) = FabElevation(
