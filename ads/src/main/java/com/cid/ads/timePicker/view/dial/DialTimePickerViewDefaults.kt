package com.cid.ads.timePicker.view.dial
...
object DialTimePickerViewDefaults {
    ...
    @Composable
    fun colors(
        clockDialColor: Color = AkaTheme.colorScheme.surfaceContainerHighest,
        selectorColor: Color = AkaTheme.colorScheme.primary,
        containerColor: Color = AkaTheme.colorScheme.surfaceContainerHigh,
        periodSelectorBorderColor: Color = AkaTheme.colorScheme.outline,
        clockDialSelectedContentColor: Color = AkaTheme.colorScheme.onPrimary,
        clockDialUnselectedContentColor: Color = AkaTheme.colorScheme.onSurface,
        periodSelectorSelectedContainerColor: Color = AkaTheme.colorScheme.tertiaryContainer,
        periodSelectorUnselectedContainerColor: Color = Color.Transparent,
        periodSelectorSelectedContentColor: Color = AkaTheme.colorScheme.onTertiaryContainer,
        periodSelectorUnselectedContentColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        timeSelectorSelectedContainerColor: Color = AkaTheme.colorScheme.primaryContainer,
        timeSelectorUnselectedContainerColor: Color = AkaTheme.colorScheme.surfaceContainerHighest,
        timeSelectorSelectedContentColor: Color = AkaTheme.colorScheme.onPrimaryContainer,
        timeSelectorUnselectedContentColor: Color = AkaTheme.colorScheme.onSurface,
    ...
    @Composable
    fun sizes(
        clockDisplayShape: Shape = AkaTheme.shapes.shape12,
        clockDisplayTextStyle: TextStyle = AkaTheme.typography.displayLarge,
        periodSelectorShape: Shape = AkaTheme.shapes.shape12,
        periodSelectorTextStyle: TextStyle = AkaTheme.typography.buttonLarge,
        clockDialNumberTextStyle: TextStyle = AkaTheme.typography.labelLarge,
