...
object ButtonDefaults {
    ...
    fun tertiaryColors(
        ...
        contentColor: Color = AkaTheme.colorScheme.primary,
        borderColor: Color = Color.Unspecified
    ) = ButtonColors(
        containerColor = containerColor,
        contentColor = contentColor,
    ...
    fun largeSizes(
        ...
        additionInfoTextStyle: TextStyle = AkaTheme.typography.labelMedium,
        height: Dp = 52.dp,
        ...
        contentPadding: PaddingValues = PaddingValues(
            horizontal = AkaTheme.spacing.size24,
            vertical = 0.dp
        ),
    ...
    @Composable
    fun mediumSizes(
        textStyle: TextStyle = AkaTheme.typography.buttonMedium,
        additionInfoTextStyle: TextStyle = AkaTheme.typography.labelSmall,
        height: Dp = 44.dp,
        ...
        contentPadding: PaddingValues = PaddingValues(
            horizontal = AkaTheme.spacing.size20,
            vertical = 0.dp
        ),
        borderThickness: Dp = 0.dp
    ) = ButtonSizes(
    ...
    @Composable
    fun smallSizes(
        textStyle: TextStyle = AkaTheme.typography.buttonSmall,
        height: Dp = 36.dp,
