...
object SwitchDefaults {
    ...
    @Composable
    fun colors(
        checkedThumbColor: Color = AkaTheme.colorScheme.onPrimary,
        checkedTrackColor: Color = AkaTheme.colorScheme.primary,
        checkedBorderColor: Color = AkaTheme.colorScheme.primary,
        checkedIconColor: Color = AkaTheme.colorScheme.onPrimaryContainer,
        uncheckedThumbColor: Color = AkaTheme.colorScheme.onPrimaryContainer,
        uncheckedTrackColor: Color = AkaTheme.colorScheme.surfaceContainerHighest,
        uncheckedBorderColor: Color = AkaTheme.colorScheme.primary,
        uncheckedIconColor: Color = AkaTheme.colorScheme.onPrimary,
    ): SwitchColors =
        SwitchColors(
    ...
    fun sizes(
        ...
        toggleShape: Shape = AkaTheme.shapes.full,
        trackShape: Shape = AkaTheme.shapes.full,
