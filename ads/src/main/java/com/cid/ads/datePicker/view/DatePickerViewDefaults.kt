...
import com.cid.ads.datePicker.view.cells.DatePickerDialogDayCell
import com.cid.ads.datePicker.view.cells.DatePickerDialogMonthCell
import com.cid.ads.datePicker.view.cells.DatePickerDialogWeekLabelCell
import com.cid.ads.datePicker.view.cells.DatePickerDialogYearCell
import com.cid.ads.datePicker.view.header.DatePickerDialogHeader
import com.cid.ads.foundation.AkaTheme
import com.cid.ads.foundation.state38
 ...
 */
object IdsDatePickerViewDefaults {
    ...
    fun headerColors(
        ...
        monthLabelColor: Color = AkaTheme.colorScheme.primary,
        yearLabelColor: Color = AkaTheme.colorScheme.primary,
    ...
    fun dayOfWeekLabelColors(
        dayOfWeekLabelColor: Color = AkaTheme.colorScheme.onSurfaceVariant
    ...
    @Composable
    fun dayCellColors(
        cellTextColor: Color = AkaTheme.colorScheme.onSurface,
        cellTextDisabledColor: Color = AkaTheme.colorScheme.onSurface.state38,
        cellTextBetweenSelectionColor: Color = AkaTheme.colorScheme.onPrimaryContainer,
        cellTextSelectedColor: Color = AkaTheme.colorScheme.onPrimary,

        currentDateIndicator: Color = AkaTheme.colorScheme.primary,
        currentDateBetweenSelectionIndicatorColor: Color = AkaTheme.colorScheme.primary,
        currentDateIndicatorSelectedColor: Color = AkaTheme.colorScheme.onPrimary,

        containerColor: Color = Color.Transparent,
        betweenSelectionContainerColor: Color = AkaTheme.colorScheme.primaryContainer,
        selectedContainerColor: Color = AkaTheme.colorScheme.primary,
    ...
    fun monthCellColors(
        ...
        selectedBackgroundColor: Color = AkaTheme.colorScheme.primary,
