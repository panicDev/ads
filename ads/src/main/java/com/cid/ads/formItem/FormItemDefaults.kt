...
object FormItemDefaults {
    ...
    @Composable
    fun formSizes(
        subheadTextStyle: TextStyle = AkaTheme.typography.labelMedium,
     ...
     * default colors from the [AkaTheme] are used.
     *
    ...
    @Composable
    fun captionColors(
        textColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        errorColor: Color = AkaTheme.colorScheme.error,
        counterColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        errorCounterColor: Color = AkaTheme.colorScheme.error,
    ) = CaptionColors(
        textColor = textColor,
    ...
    fun captionSizes(
        ...
        counterTextStyle: TextStyle = AkaTheme.typography.bodySmall
    ) = CaptionSizes(
    ...
    fun subheadColors(
        ...
        requiredColor: Color = AkaTheme.colorScheme.error,
    ) = SubheadColors(
        textColor = textColor,
