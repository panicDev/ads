package com.cid.ads.avatarAndImage
...
object AvatarDefaults {
    ...
    fun size96(
        ...
        initialsTextStyle: TextStyle = AkaTheme.typography.bodyLarge.copy(
            fontSize = 36.sp,
    ...
    @Composable
    fun colors(
        placeholderContainerColor: Color = AkaTheme.colorScheme.surfaceContainer,
        borderColor: Color = AkaTheme.colorScheme.outlineVariant,
        placeholderIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant.state38,
        overlayIconColor: Color = AkaTheme.colorScheme.primary,
        initialsTextColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        initialsContainerColor: Color = AkaTheme.colorScheme.surfaceContainerHighest,
    ) = AvatarColors(
