...
import com.cid.ads.foundation.shape.SquircleShape
import com.cid.ads.foundation.shape.SquircleSmoothing
...
object ImageDefaults {
    ...
    fun colors(
        ...
        placeholderIconColor: Color = AkaTheme.colorScheme.onSurface.state38,
