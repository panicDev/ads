package com.cid.ads.progressIndicator
...
object ProgressIndicatorDefaults {
    ...
    @Composable
    fun colors(
        trackColor: Color = AkaTheme.colorScheme.secondaryContainer,
        progressColor: Color = AkaTheme.colorScheme.primary,
    ...
    fun linearLarge(
        ...
        contentTextStyle: TextStyle = AkaTheme.typography.labelLarge
    ...
    fun linearMedium(
        ...
        stopSize: Dp = 3.dp,
        strokeCap: StrokeCap = StrokeCap.Round,
        contentTextStyle: TextStyle = AkaTheme.typography.labelMedium
    ) = LinearProgressBarSizes(
        strokeSize = strokeSize,
        gapSize = gapSize,
        stopSize = stopSize,
    ...
    fun linearSmall(
        ...
        stopSize: Dp = 2.dp,
        strokeCap: StrokeCap = StrokeCap.Round,
        contentTextStyle: TextStyle = AkaTheme.typography.labelSmall.copy(fontWeight = FontWeight.Medium)
    ) = LinearProgressBarSizes(
        strokeSize = strokeSize,
        gapSize = gapSize,
        stopSize = stopSize,
