...
import com.cid.adsSymbols.check.circle.CheckCircle
import com.cid.adsSymbols.exclamation.circle.ExclamationCircle
...
object InputsDefaults {
    ...
    fun outlineColors(
        //State Icon
        validStateIcon: Painter = rememberVectorPainter(image = IdsSymbols.Default.CheckCircle),
        errorStateIcon: Painter = rememberVectorPainter(image = IdsSymbols.Default.ExclamationCircle),

        //State Icon Colors
        validStateIconColor: Color = AkaTheme.colorScheme.valid,
        errorStateIconColor: Color = AkaTheme.colorScheme.error,
        ...
        //Leading Icon Colors
        defaultLeadingIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        hoveredLeadingIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        focusedLeadingIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        validLeadingIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        errorLeadingIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,

        //Trailing Icon Colors
        defaultTrailingIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        hoveredTrailingIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        focusedTrailingIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        validTrailingIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        errorTrailingIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,

        //Placeholder Colors
        defaultPlaceholderColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        hoveredPlaceholderColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        focusedPlaceholderColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        validPlaceholderColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        errorPlaceholderColor: Color = AkaTheme.colorScheme.error,

        //Suffix Colors
        defaultSuffixColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        hoveredSuffixColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        focusedSuffixColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        validSuffixColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        errorSuffixColor: Color = AkaTheme.colorScheme.error,
    ) = InputColors(
        //State Icon
    ...
    fun plainColors(
        ...
        hoveredSuffixColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        focusedSuffixColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        validSuffixColor: Color = AkaTheme.colorScheme.valid,
        errorSuffixColor: Color = AkaTheme.colorScheme.error,
    ) = InputColors(
        //State Icon
        errorStateIcon = errorStateIcon,
    ...
    fun sizes(
        ...
        shape: Shape = AkaTheme.shapes.shape16,
        contentPaddingValues: PaddingValues = PaddingValues(
            horizontal = AkaTheme.spacing.size12
        ),
        ...
        placeholderTextStyle: TextStyle = AkaTheme.typography.bodyLarge,
        inputTextStyle: TextStyle = AkaTheme.typography.bodyLarge,
        suffixTextStyle: TextStyle = AkaTheme.typography.labelMedium
    ) = InputSizes(
