package com.cid.ads.pageIndicator
...
import com.cid.ads.pageIndicator.IndicatorOrientation.HORIZONTAL
import com.cid.ads.pageIndicator.IndicatorOrientation.VERTICAL
import com.cid.ads.pageIndicator.IndicatorStyle.DOT
import com.cid.ads.pageIndicator.IndicatorStyle.LINE
...
fun PageIndicator(
    ...
    val space = when (style) {
        DOT -> AkaTheme.spacing.size8
        LINE -> AkaTheme.spacing.size4
    }
