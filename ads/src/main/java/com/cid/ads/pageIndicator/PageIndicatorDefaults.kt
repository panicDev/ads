...
object PageIndicatorDefaults {
     ...
     * it uses default colors from the [AkaTheme].
     *
    ...
    @Composable
    fun indicatorColor(
        defaultIndicatorColor: Color = AkaTheme.colorScheme.onSurface.state38,
        selectedIndicatorColor: Color = AkaTheme.colorScheme.onSurface,
    ) = PageIndicatorColors(
