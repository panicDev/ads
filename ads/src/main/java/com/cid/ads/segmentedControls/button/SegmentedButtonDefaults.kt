package com.cid.ads.segmentedControls.button
...
object SegmentedButtonDefaults {
    ...
    @Composable
    fun segmentColors(
        activeContainerColor: Color = AkaTheme.colorScheme.primary,
        activeContentColor: Color = AkaTheme.colorScheme.onPrimary,
