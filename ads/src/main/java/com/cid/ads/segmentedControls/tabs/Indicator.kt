...
import com.cid.ads.segmentedControls.tabs.util.TabPosition
import com.cid.ads.segmentedControls.tabs.util.TabRowIndicatorSpec
 ...
 */
@Composable
fun SelectedTabIndicatorScope.Indicator(
    ...
    Spacer(
        modifier = modifier
            .fillMaxHeight()
            .fillMaxWidth()
            .background(color = colors.indicatorColor, shape = sizes.segmentShape)
    )
}
 ...
 */
interface SelectedTabIndicatorScope {
