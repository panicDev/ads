package com.cid.ads.segmentedControls.tabs
...
object SegmentedTabsDefaults {
    ...
    @Composable
    fun colors(
        indicatorColor: Color = AkaTheme.colorScheme.surface,
        containerColor: Color = AkaTheme.colorScheme.surfaceContainerHighest,
        activeContentColor: Color = AkaTheme.colorScheme.onSurface,
        inactiveContentColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
    ) = SegmentedTabsColors(
    ...
    fun smallSizes(
        ...
        labelTextStyle: TextStyle = AkaTheme.typography.buttonSmall,
        indicatorPadding: Dp = AkaTheme.spacing.size2,
        shape: CornerBasedShape = AkaTheme.shapes.shape12,
        segmentShape: CornerBasedShape = AkaTheme.shapes.shape10
    ) = SegmentedTabsSizes(
        height = height,
        iconSize = iconSize,
    ...
    fun mediumSizes(
        ...
        labelTextStyle: TextStyle = AkaTheme.typography.buttonMedium,
        indicatorPadding: Dp = AkaTheme.spacing.size2,
        shape: CornerBasedShape = AkaTheme.shapes.shape14,
        segmentShape: CornerBasedShape = AkaTheme.shapes.shape12
    ) = SegmentedTabsSizes(
        height = height,
        iconSize = iconSize,
        labelTextStyle = labelTextStyle,
    ...
    fun largeSizes(
        ...
        labelTextStyle: TextStyle = AkaTheme.typography.buttonLarge,
        indicatorPadding: Dp = AkaTheme.spacing.size2,
        shape: CornerBasedShape = AkaTheme.shapes.shape16,
        segmentShape: CornerBasedShape = AkaTheme.shapes.shape14
    ) = SegmentedTabsSizes(
        height = height,
        iconSize = iconSize,
        labelTextStyle = labelTextStyle,
