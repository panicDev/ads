    ...
    Column(
        ...
        if (state.isSupportOpacity) {
            Row(
                ...
                horizontalArrangement = Arrangement.spacedBy(AkaTheme.spacing.size6)
            ) {
                AlphaSliderView(
                ...
                Box(
                    modifier = Modifier
                        ...
                        .padding(horizontal = AkaTheme.spacing.size14),
                    ...
                    Text(
                        ...
                        style = AkaTheme.typography.titleMedium.copy(baselineShift = BaselineShift.None),
