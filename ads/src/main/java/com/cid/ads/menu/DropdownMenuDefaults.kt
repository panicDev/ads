...
object MenuDefaults {
    ...
    @Composable
    fun colors(
        backgroundColor: Color = AkaTheme.colorScheme.surfaceContainer,
    ...
    fun itemColors(
        ...
        negativeTitleColor: Color = AkaTheme.colorScheme.error,
        leadingIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        selectedLeadingIconColor: Color = AkaTheme.colorScheme.primary,
        negativeLeadingIconColor: Color = AkaTheme.colorScheme.error,
        expendIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
    ...
    @Composable
    fun itemSizes(
        titleTextStyle: TextStyle = AkaTheme.typography.labelLarge,
        ...
        newLabelContainerShape: Shape = AkaTheme.shapes.shape6,
