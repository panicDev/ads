...
object ActionSheetDefaults {
    ...
    fun colors(
        ...
        subtitleColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
    ...
    fun itemColors(
        ...
        destructiveTextColor: Color = AkaTheme.colorScheme.error,

        defaultIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        destructiveIconColor: Color = AkaTheme.colorScheme.error,
    ...
    fun sizes(
        ...
        containerShape: Shape = AkaTheme.shapes.shape20,
