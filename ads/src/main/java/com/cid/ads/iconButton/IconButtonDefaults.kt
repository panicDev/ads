package com.cid.ads.iconButton
...
object IconButtonDefaults {
    ...
    fun primaryToggleIconButtonColors(
        ...
        contentColor: Color = AkaTheme.colorScheme.primary,
        borderColor: Color = Color.Transparent,
        checkedContainerColor: Color = AkaTheme.colorScheme.primary,
        checkedContentColor: Color = AkaTheme.colorScheme.onPrimary,
    ...
    fun secondaryToggleIconButtonColors(
        ...
        borderColor: Color = Color.Transparent,
        checkedContainerColor: Color = AkaTheme.colorScheme.primaryContainer,
        checkedContentColor: Color = AkaTheme.colorScheme.onPrimaryContainer,
        checkedBorderColor: Color = Color.Transparent
    ) = ToggleIconButtonColors(
        containerColor = containerColor,
        contentColor = contentColor,
    ...
    fun tertiaryToggleIconButtonColors(
        ...
        checkedContentColor: Color = AkaTheme.colorScheme.primary,
        checkedBorderColor: Color = Color.Transparent,
    ) = ToggleIconButtonColors(
        containerColor = containerColor,
        contentColor = contentColor,
    ...
    fun outlinedToggleIconButtonColors(
        ...
        checkedContainerColor: Color = AkaTheme.colorScheme.primary,
        checkedContentColor: Color = AkaTheme.colorScheme.onPrimary,
        checkedBorderColor: Color = AkaTheme.colorScheme.primary
    ) = ToggleIconButtonColors(
        containerColor = containerColor,
        contentColor = contentColor,
        borderColor = borderColor,
