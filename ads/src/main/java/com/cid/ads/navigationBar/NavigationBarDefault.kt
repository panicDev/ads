package com.cid.ads.navigationBar
...
object NavigationBarDefaults {
    ...
    @Composable
    fun itemColors(
        selectedIconColor: Color = AkaTheme.colorScheme.onSecondaryContainer,
        selectedTextColor: Color = AkaTheme.colorScheme.onSurface,
        indicatorColor: Color = AkaTheme.colorScheme.secondaryContainer,
        unselectedIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        unselectedTextColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
