...
import com.cid.ads.foundation.animateElevation
...
object ToggleableChipDefaults {
    ...
    fun chipColors(
        ...
        labelColor: Color = AkaTheme.colorScheme.onSurface,
        leadingIconColor: Color = AkaTheme.colorScheme.primary,
        trailingIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        selectedContainerColor: Color = AkaTheme.colorScheme.secondaryContainer,
        selectedLabelColor: Color = AkaTheme.colorScheme.onSecondaryContainer,
        selectedLeadingIconColor: Color = AkaTheme.colorScheme.onSecondaryContainer,
        selectedTrailingIconColor: Color = AkaTheme.colorScheme.onSurfaceVariant,
        borderColor: Color = AkaTheme.colorScheme.primary,
    ...
    fun smallSizes(
        ...
        shape: Shape = AkaTheme.shapes.shape10,
        labelStyle: TextStyle = AkaTheme.typography.labelSmall,
        ...
        contentSpacing: Dp = AkaTheme.spacing.size4,
    ...
    fun mediumSizes(
        ...
        borderWidth: Dp = 1.dp,
        selectedBorderWith: Dp = 0.dp,
        shape: Shape = AkaTheme.shapes.shape12,
        labelStyle: TextStyle = AkaTheme.typography.labelMedium,
        ...
        contentSpacing: Dp = AkaTheme.spacing.size6,
        contentPadding: PaddingValues = PaddingValues(
            horizontal = AkaTheme.spacing.size14
        )
    ) = ToggleableChipSizes(
        height = height,
        shape = shape,
    ...
    fun largeSizes(
        ...
        borderWidth: Dp = 1.dp,
        selectedBorderWith: Dp = 0.dp,
        shape: Shape = AkaTheme.shapes.shape14,
        ...
        contentSpacing: Dp = AkaTheme.spacing.size8,
        contentPadding: PaddingValues = PaddingValues(
            horizontal = AkaTheme.spacing.size16
        )
    ) = ToggleableChipSizes(
        height = height,
        shape = shape,
