...
import com.cid.ads.menu.DropdownMenu
import com.cid.ads.menu.DropdownMenuItemScope
import com.cid.ads.topAppBar.util.LayoutId
import com.cid.adsSymbols.ellepsis.vert.EllipsisVert
...
fun TopAppBarTrailingScope.More(
    ...
    icon: Painter = rememberVectorPainter(IdsSymbols.Default.EllipsisVert),
