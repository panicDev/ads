...
object TopAppBarDefaults {
    ...
    fun colors(
        ...
        scrolledContainerColor: Color = AkaTheme.colorScheme.surfaceContainer,
        leadingIconButtonColors: IconButtonColors = IconButtonDefaults.tertiaryIconButtonColors(
            contentColor = AkaTheme.colorScheme.onSurfaceVariant
        ),
        leadingAvatarColors: AvatarColors = AvatarDefaults.colors(),
        titleTextColor: Color = AkaTheme.colorScheme.onSurface,
        counterColors: CounterColors = CounterDefaults.primaryColors(),
        trailingActionButtonColor: Color = AkaTheme.colorScheme.primary,
    ...
    fun sizes(
        ...
        titleTextStyle: TextStyle = AkaTheme.typography.titleLarge,
