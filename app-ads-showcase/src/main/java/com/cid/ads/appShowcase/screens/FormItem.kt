...
import com.cid.ads.formItem.Caption
...
import com.cid.ads.formItem.Select
    ...
    override fun Content(navController: NavController?) {
        ...
        SampleScaffold(
            ...
            Column(
                ...
                FormItem(
                    modifier = Modifier.padding(top = AkaTheme.spacing.size2),
                    enabled = enabled,
                    isError = isError,
                    isValid = isValid,
                    content = {
                        when {
                            contentState[0].value -> {
                                Input(
                                    ...
                                    trailingIcon = if (trailing) rememberVectorPainter(image = IdsSymbols.Default.XMark) else null,
