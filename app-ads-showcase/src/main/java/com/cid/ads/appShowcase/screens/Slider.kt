...
import com.cid.ads.slider.centered.CenteredSlider
import com.cid.ads.slider.centered.DiscreteCenteredSlider
import com.cid.ads.slider.content.Icon
import com.cid.ads.slider.content.Text
import com.cid.ads.slider.continuous.DiscreteSlider
import com.cid.ads.slider.continuous.Slider
import com.cid.ads.slider.range.DiscreteRangeSlider
import com.cid.ads.slider.range.RangeSlider
import com.cid.ads.text.Text
import com.cid.adsSymbols.foundation.IdsSymbols
import com.cid.adsSymbols.speaker.Speaker
import com.cid.adsSymbols.speaker.minus.SpeakerMinus
import com.cid.adsSymbols.speaker.wave.two.SpeakerWave2
                    ...
                    when {
                        typeStates[0].value -> {
                            when {
                                modeStates[0].value -> {
                                    Column(
                                        modifier = Modifier.padding(horizontal = AkaTheme.spacing.size24),
                                            ...
                                            leading = if (values) {
                                                {
                                                    when {
                                                        ...
                                                        contentStates[1].value -> {
                                                            Icon(icon = rememberVectorPainter(image = IdsSymbols.Filled.Speaker))
                                                        }
                                                    }
                                                }
                                            } else null,
                                            trailing = if (values) {
                                                {
                                                    when {
                                                        ...
                                                        contentStates[1].value -> {
                                                            Icon(icon = rememberVectorPainter(image = IdsSymbols.Filled.SpeakerWave2))
                                                        }
                                                    }
                                                }
                                            } else null
                                ...
                                modeStates[1].value -> {
                                    Column(
                                        modifier = Modifier
                                            .padding(horizontal = AkaTheme.spacing.size24),
                                        horizontalAlignment = Alignment.CenterHorizontally
                                    ) {
                                        Text(
                                            modifier = Modifier.width(40.dp),
                                            ...
                                            trailing = if (values) {
                                                {
                                                    when {
                                                        ...
                                                        contentStates[1].value -> {
                                                            Icon(icon = rememberVectorPainter(image = IdsSymbols.Filled.SpeakerMinus))
                                                        }
                                                    }
                                                }
                                            } else null
