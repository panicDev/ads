...
import com.cid.ads.actionSheet.Action
import com.cid.ads.actionSheet.ActionSheet
        ...
        if (needShow) {
            ActionSheet(
                ...
                actions = {
                    Action(
                        text = "Action 1",
                        leadingIcon = if (icons) rememberVectorPainter(IdsSymbols.Default.Image) else null,
