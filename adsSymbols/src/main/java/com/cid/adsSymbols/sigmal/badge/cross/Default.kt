package com.cid.adsSymbols.sigmal.badge.cross
...
val IdsSymbols.Default.SignalBadgeCross: ImageVector
    get() {
        if (signalBadgeCross != null) {
            return signalBadgeCross!!
        }
        signalBadgeCross = Builder(
            name = "signal-badge-cross-default",
...
private var signalBadgeCross: ImageVector? = null