package com.cid.adsSymbols.sigmal.badge.exclamation
...
val IdsSymbols.Default.SignalBadgeExclamation: ImageVector
    get() {
        if (signalBadgeExclamation != null) {
            return signalBadgeExclamation!!
        }
        signalBadgeExclamation = Builder(
            name = "signal-badge-exclamation-default",
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(13f, 11f)
                verticalLineTo(15.705f)
                curveTo(12.679f, 16.404f, 12.5f, 17.181f, 12.5f, 18f)
                curveTo(12.5f, 18.819f, 12.679f, 19.596f, 13f, 20.295f)
                verticalLineTo(21f)
...
private var signalBadgeExclamation: ImageVector? = null