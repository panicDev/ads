package com.cid.adsSymbols.device.computer.apple
...
val IdsSymbols.Default.DeviceComputerApple: ImageVector
    get() {
        if (deviceComputerApple != null) {
            return deviceComputerApple!!
        }
        deviceComputerApple = Builder(
            name = "device-computer-apple-default",
...
private var deviceComputerApple: ImageVector? = null