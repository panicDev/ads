package com.cid.adsSymbols.device.computer.badge.arrow.down
...
val IdsSymbols.Default.DeviceComputerArrowDown: ImageVector
    get() {
        if (deviceComputerArrowDown != null) {
            return deviceComputerArrowDown!!
        }
        deviceComputerArrowDown = Builder(
            name = "device-computer-arrow-down-default",
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(13.174f, 3.235f, 13.638f, 2.554f, 14.225f, 2f)
                horizontalLineTo(6.5f)
...
private var deviceComputerArrowDown: ImageVector? = null