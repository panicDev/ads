package com.cid.adsSymbols.device.mobile.arrowDown
...
val IdsSymbols.Filled.DeviceMobileArrowDown: ImageVector
    get() {
        if (deviceMobileArrowDown != null) {
            return deviceMobileArrowDown!!
        }
        deviceMobileArrowDown = Builder(
            name = "device-mobile-arrow-down-filled",
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(13.393f, 2.785f, 12.806f, 3.828f, 12.591f, 5f)
                horizontalLineTo(6f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(12.775f, 9.303f, 15.131f, 11.5f, 18f, 11.5f)
                verticalLineTo(17f)
                horizontalLineTo(6f)
                verticalLineTo(6.5f)
                close()
...
private var deviceMobileArrowDown: ImageVector? = null