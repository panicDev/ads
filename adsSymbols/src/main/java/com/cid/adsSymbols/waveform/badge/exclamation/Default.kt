package com.cid.adsSymbols.waveform.badge.exclamation
...
val IdsSymbols.Default.WaveformBadgeExclamation: ImageVector
    get() {
        if (waveformBadgeExclamation != null) {
            return waveformBadgeExclamation!!
        }
        waveformBadgeExclamation = ImageVector.Builder(
            name = "waveform-badge-exclamation-default",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var waveformBadgeExclamation: ImageVector? = null