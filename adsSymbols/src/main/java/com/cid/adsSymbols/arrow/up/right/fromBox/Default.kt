package com.cid.adsSymbols.arrow.up.right.fromBox
...
val IdsSymbols.Default.ArrowUpRightFromBox: ImageVector
    get() {
        if (arrowUpRightFromBox != null) {
            return arrowUpRightFromBox!!
        }
        arrowUpRightFromBox = ImageVector.Builder(
            name = "arrow-up-right-from-box-default",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(10.902f, 11.684f, 10.902f, 12.317f, 11.293f, 12.707f)
...
private var arrowUpRightFromBox: ImageVector? = null
