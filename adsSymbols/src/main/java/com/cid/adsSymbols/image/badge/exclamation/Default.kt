package com.cid.adsSymbols.image.badge.exclamation
...
val IdsSymbols.Default.ImageBadgeExclamation: ImageVector
    get() {
        if (imageBadgeExclamation != null) {
            return imageBadgeExclamation!!
        }
        imageBadgeExclamation = ImageVector.Builder(
            name = "image-badge-exclamation-default",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var imageBadgeExclamation: ImageVector? = null