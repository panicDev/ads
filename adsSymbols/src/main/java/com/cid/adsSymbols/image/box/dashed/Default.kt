package com.cid.adsSymbols.image.box.dashed
...
val IdsSymbols.Default.ImageDashed: ImageVector
    get() {
        if (imageDashed != null) {
            return imageDashed!!
        }
        imageDashed = Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                lineTo(5f, 16.5f)
                curveTo(4.999f, 17.881f, 6.119f, 19f, 7.5f, 19f)
                horizontalLineTo(10f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(8.868f, 12.985f, 9.159f, 12.961f, 9.334f, 13.138f)
