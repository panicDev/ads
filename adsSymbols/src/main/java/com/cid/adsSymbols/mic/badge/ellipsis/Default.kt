package com.cid.adsSymbols.mic.badge.ellipsis
...
val IdsSymbols.Default.MicBadgeEllipsis: ImageVector
    get() {
        if (micBadgeEllipsis != null) {
            return micBadgeEllipsis!!
        }
        micBadgeEllipsis = ImageVector.Builder(
            name = "mic-badge-ellipsis-default",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var micBadgeEllipsis: ImageVector? = null