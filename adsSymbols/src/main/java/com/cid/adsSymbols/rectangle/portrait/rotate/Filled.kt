package com.cid.adsSymbols.rectangle.portrait.rotate
...
val IdsSymbols.Filled.RectanglePortraitRotate: ImageVector
    get() {
        ...
        rectanglePortraitRotate = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(9f, 9f)
                curveTo(9f, 8.172f, 9.672f, 7.5f, 10.5f, 7.5f)
                horizontalLineTo(13.5f)
                curveTo(14.328f, 7.5f, 15f, 8.172f, 15f, 9f)
                verticalLineTo(15f)
                curveTo(15f, 15.828f, 14.328f, 16.5f, 13.5f, 16.5f)
                horizontalLineTo(10.5f)
                curveTo(9.672f, 16.5f, 9f, 15.828f, 9f, 15f)
                verticalLineTo(9f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
