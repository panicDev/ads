package com.cid.adsSymbols.rectangle.landscape.rotate
    ...
    get() {
        ...
        rectangleLandscapeRotate = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(8.8f, 15f)
                curveTo(7.806f, 15f, 7f, 14.194f, 7f, 13.2f)
                verticalLineTo(10.8f)
                curveTo(7f, 9.806f, 7.806f, 9f, 8.8f, 9f)
                lineTo(15.2f, 9f)
                curveTo(16.194f, 9f, 17f, 9.806f, 17f, 10.8f)
                verticalLineTo(13.2f)
                curveTo(17f, 14.194f, 16.194f, 15f, 15.2f, 15f)
