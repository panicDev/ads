package com.cid.adsSymbols.file.badge.ellipsis
...
val IdsSymbols.Default.FileBadgeEllipsis: ImageVector
    get() {
        if (fileBadgeEllipsis != null) {
            return fileBadgeEllipsis!!
        }
        fileBadgeEllipsis = ImageVector.Builder(
            name = "file-badge-ellipsis-default",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var fileBadgeEllipsis: ImageVector? = null