package com.cid.adsSymbols.speaker.plus
...
val IdsSymbols.Default.SpeakerPlus: ImageVector
    get() {
        if (speakerPlus != null) {
            return speakerPlus!!
        }
        speakerPlus = ImageVector.Builder(
            name = "speaker-plus-default",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(18.001f, 8f)
                curveTo(18.553f, 8f, 19.001f, 8.448f, 19.001f, 9f)
                verticalLineTo(11.001f)
                horizontalLineTo(21.002f)
                curveTo(21.554f, 11.001f, 22.002f, 11.448f, 22.002f, 12.001f)
                curveTo(22.002f, 12.553f, 21.554f, 13.001f, 21.002f, 13.001f)
                horizontalLineTo(19.001f)
                verticalLineTo(15.002f)
                curveTo(19.001f, 15.554f, 18.553f, 16.002f, 18.001f, 16.002f)
                curveTo(17.448f, 16.002f, 17.001f, 15.554f, 17.001f, 15.002f)
                verticalLineTo(13.001f)
                horizontalLineTo(15f)
                curveTo(14.448f, 13.001f, 14f, 12.553f, 14f, 12.001f)
                curveTo(14f, 11.448f, 14.448f, 11.001f, 15f, 11.001f)
                horizontalLineTo(17.001f)
                verticalLineTo(9f)
                curveTo(17.001f, 8.448f, 17.448f, 8f, 18.001f, 8f)
                close()
            }
        }.build()
