package com.cid.adsSymbols.envelope.paperClip
...
val IdsSymbols.Default.EnvelopePaperClip: ImageVector
    get() {
        ...
        envelopePaperClip = Builder(
            ...
            path(
                ...
                curveTo(16.108f, 19.498f, 16.109f, 19.044f, 16.11f, 18.818f)
                lineTo(16.11f, 18.778f)
                verticalLineTo(18f)
                horizontalLineTo(6.5f)
                curveTo(6.098f, 18f, 5.718f, 17.905f, 5.381f, 17.736f)
                ...
                curveTo(16.11f, 13.95f, 16.176f, 13.602f, 16.297f, 13.293f)
                lineTo(15.032f, 12.029f)
                lineTo(19.717f, 7.344f)
                curveTo(19.898f, 7.689f, 20f, 8.083f, 20f, 8.5f)
                verticalLineTo(12.202f)
                curveTo(20.04f, 12.23f, 20.079f, 12.259f, 20.118f, 12.291f)
                ...
                horizontalLineTo(6.5f)
                close()
                moveTo(5.344f, 6.283f)
                curveTo(5.689f, 6.102f, 6.083f, 6f, 6.5f, 6f)
                horizontalLineTo(17.5f)
                curveTo(17.917f, 6f, 18.311f, 6.102f, 18.656f, 6.283f)
                lineTo(12.53f, 12.409f)
                curveTo(12.237f, 12.702f, 11.763f, 12.702f, 11.47f, 12.409f)
                lineTo(5.344f, 6.283f)
                close()
                moveTo(4.283f, 7.344f)
                curveTo(4.102f, 7.689f, 4f, 8.083f, 4f, 8.5f)
                verticalLineTo(15.5f)
                curveTo(4f, 15.932f, 4.11f, 16.339f, 4.303f, 16.694f)
                lineTo(8.968f, 12.029f)
                lineTo(4.283f, 7.344f)
                close()
