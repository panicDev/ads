package com.cid.adsSymbols.camera.badge.plus
    ...
    get() {
        ...
        cameraBadgePlus = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(17.152f, 12.045f, 17.571f, 12f, 18f, 12f)
                curveTo(19.537f, 12f, 20.938f, 12.578f, 22f, 13.528f)
                verticalLineTo(8.42f)
                curveTo(22f, 6.117f, 20.133f, 4.25f, 17.83f, 4.25f)
                curveTo(16.944f, 4.25f, 16.094f, 3.895f, 15.471f, 3.264f)
                lineTo(14.809f, 2.595f)
                curveTo(14.434f, 2.214f, 13.921f, 2f, 13.387f, 2f)
                horizontalLineTo(10.613f)
                curveTo(10.079f, 2f, 9.566f, 2.214f, 9.191f, 2.595f)
                lineTo(8.529f, 3.264f)
                curveTo(7.906f, 3.895f, 7.056f, 4.25f, 6.17f, 4.25f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(12.706f, 15.173f)
                curveTo(13.266f, 14.127f, 14.127f, 13.266f, 15.173f, 12.706f)
