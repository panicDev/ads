package com.cid.adsSymbols.camera.badge.ellipsis
...
val IdsSymbols.Default.CameraBadgeEllipsis: ImageVector
    get() {
        if (cameraBadgeEllipsis != null) {
            return cameraBadgeEllipsis!!
        }
        cameraBadgeEllipsis = ImageVector.Builder(
            name = "camera-badge-ellipsis-default",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var cameraBadgeEllipsis: ImageVector? = null
