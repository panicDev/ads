package com.cid.adsSymbols.brightness.medium
...
val IdsSymbols.Filled.BrightnessMedium: ImageVector
    get() {
        ...
        brightnessMedium = Builder(
            ...
            path(
                ...
                close()
                moveTo(17f, 12f)
                curveTo(17f, 14.421f, 15.279f, 16.44f, 12.994f, 16.901f)
                curveTo(12.452f, 17.01f, 12f, 16.552f, 12f, 16f)
                verticalLineTo(8f)
                curveTo(12f, 7.448f, 12.452f, 6.989f, 12.994f, 7.099f)
                curveTo(15.279f, 7.559f, 17f, 9.579f, 17f, 12f)
                close()
            }
        }.build()
        return brightnessMedium!!
