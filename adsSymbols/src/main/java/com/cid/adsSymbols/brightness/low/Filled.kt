package com.cid.adsSymbols.brightness.low
...
val IdsSymbols.Filled.BrightnessLow: ImageVector
    get() {
        ...
        brightnessLow = Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(14.716f, 4.721f, 15.226f, 4.932f, 15.758f, 4.931f)
                lineTo(17.068f, 4.93f)
                curveTo(18.174f, 4.929f, 19.07f, 5.826f, 19.069f, 6.932f)
                lineTo(19.068f, 8.242f)
                curveTo(19.068f, 8.774f, 19.279f, 9.283f, 19.655f, 9.659f)
                ...
                curveTo(4.721f, 9.283f, 4.932f, 8.774f, 4.932f, 8.242f)
                lineTo(4.931f, 6.932f)
                curveTo(4.93f, 5.826f, 5.826f, 4.929f, 6.932f, 4.93f)
                lineTo(8.242f, 4.931f)
