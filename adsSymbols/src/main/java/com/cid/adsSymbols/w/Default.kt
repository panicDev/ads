...
val IdsSymbols.Default.W: ImageVector
    get() {
        if (w != null) {
            return w!!
        }
        w = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(4.309f, 2.4f, 4.847f, 2.734f, 4.973f, 3.271f)
                lineTo(8.001f, 16.136f)
                lineTo(11.031f, 3.271f)
                curveTo(11.138f, 2.819f, 11.541f, 2.5f, 12.005f, 2.5f)
                curveTo(12.469f, 2.5f, 12.872f, 2.82f, 12.978f, 3.271f)
                lineTo(16f, 16.132f)
                lineTo(19.027f, 3.271f)
                curveTo(19.153f, 2.734f, 19.691f, 2.4f, 20.229f, 2.527f)
                curveTo(20.767f, 2.653f, 21.1f, 3.192f, 20.973f, 3.729f)
                ...
                curveTo(2.9f, 3.192f, 3.233f, 2.653f, 3.771f, 2.527f)
                close()
            }
        }.build()
