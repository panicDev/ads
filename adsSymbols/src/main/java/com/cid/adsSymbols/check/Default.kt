package com.cid.adsSymbols.check
...
val IdsSymbols.Default.Check: ImageVector
    get() {
        if (check != null) {
            return check!!
        }
        check = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                lineTo(8.99f, 16.76f)
                curveTo(9.04f, 16.829f, 9.1f, 16.892f, 9.172f, 16.949f)
                curveTo(9.373f, 17.111f, 9.626f, 17.189f, 9.879f, 17.186f)
                curveTo(10.131f, 17.189f, 10.384f, 17.111f, 10.586f, 16.949f)
                curveTo(10.657f, 16.892f, 10.717f, 16.829f, 10.767f, 16.76f)
