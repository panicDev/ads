package com.cid.adsSymbols.check.line
...
val IdsSymbols.Default.CheckLine: ImageVector
    get() {
        if (checkLine != null) {
            return checkLine!!
        }
        checkLine = Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(10.717f, 15.329f, 10.657f, 15.392f, 10.586f, 15.45f)
                curveTo(10.383f, 15.612f, 10.129f, 15.689f, 9.876f, 15.686f)
                curveTo(9.624f, 15.688f, 9.372f, 15.61f, 9.171f, 15.45f)
                curveTo(9.1f, 15.392f, 9.04f, 15.329f, 8.991f, 15.26f)
                lineTo(4.855f, 11.125f)
                curveTo(4.465f, 10.734f, 4.498f, 10.138f, 4.929f, 9.793f)
                curveTo(5.36f, 9.448f, 6.026f, 9.484f, 6.417f, 9.875f)
