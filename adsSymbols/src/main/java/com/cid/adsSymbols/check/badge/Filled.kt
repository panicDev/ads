package com.cid.adsSymbols.check.badge
...
val IdsSymbols.Filled.CheckBadge: ImageVector
    get() {
        if (checkBadge != null) {
            return checkBadge!!
        }
        checkBadge = Builder(
            ...
            path(
                ...
                curveTo(9.787f, 4.14f, 9.171f, 4.341f, 8.56f, 4.254f)
                lineTo(8.038f, 4.181f)
                curveTo(6.97f, 4.029f, 5.974f, 4.753f, 5.788f, 5.815f)
                lineTo(5.697f, 6.335f)
                curveTo(5.59f, 6.942f, 5.209f, 7.467f, 4.664f, 7.756f)
                lineTo(4.199f, 8.003f)
                curveTo(3.246f, 8.508f, 2.865f, 9.679f, 3.339f, 10.648f)
                lineTo(3.571f, 11.121f)
                ...
                curveTo(5.209f, 16.533f, 5.59f, 17.057f, 5.697f, 17.665f)
                ...
                lineTo(10.609f, 20.654f)
                curveTo(11.385f, 21.405f, 12.615f, 21.405f, 13.391f, 20.654f)
                ...
                curveTo(18.41f, 17.057f, 18.791f, 16.533f, 19.336f, 16.244f)
                lineTo(19.801f, 15.997f)
                curveTo(20.754f, 15.491f, 21.135f, 14.321f, 20.661f, 13.352f)
                lineTo(20.429f, 12.878f)
                curveTo(20.158f, 12.324f, 20.158f, 11.676f, 20.429f, 11.121f)
                lineTo(20.661f, 10.648f)
                curveTo(21.135f, 9.679f, 20.754f, 8.508f, 19.801f, 8.003f)
                lineTo(19.336f, 7.756f)
                curveTo(18.791f, 7.467f, 18.41f, 6.942f, 18.303f, 6.335f)
                lineTo(18.212f, 5.815f)
                curveTo(18.026f, 4.753f, 17.03f, 4.029f, 15.962f, 4.181f)
                lineTo(15.44f, 4.254f)
                curveTo(14.829f, 4.341f, 14.213f, 4.14f, 13.769f, 3.712f)
                lineTo(13.391f, 3.345f)
                close()
                moveTo(15.78f, 10.28f)
                curveTo(16.073f, 9.987f, 16.073f, 9.512f, 15.78f, 9.219f)
                curveTo(15.487f, 8.927f, 15.013f, 8.927f, 14.72f, 9.219f)
                lineTo(10.75f, 13.189f)
                lineTo(9.28f, 11.719f)
                curveTo(8.987f, 11.427f, 8.513f, 11.427f, 8.22f, 11.719f)
