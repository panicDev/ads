package com.cid.adsSymbols.calendar.badge.exclamation
...
val IdsSymbols.Default.CalendarBadgeExclamation: ImageVector
    get() {
        if (calendarBadgeExclamation != null) {
            return calendarBadgeExclamation!!
        }
        calendarBadgeExclamation = ImageVector.Builder(
            name = "calendar-badge-exclamation-default",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                curveTo(20.403f, 13f, 19.727f, 12.724f, 19f, 12.59f)
                verticalLineTo(9.75f)
                horizontalLineTo(5f)
                verticalLineTo(17.5f)
                curveTo(5f, 18.881f, 6.119f, 20f, 7.5f, 20f)
                horizontalLineTo(12.875f)
                curveTo(13.174f, 20.765f, 13.639f, 21.446f, 14.225f, 22f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(17.013f, 12.577f, 16.678f, 12.649f, 16.355f, 12.75f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(13.755f, 14.423f, 13.299f, 15.042f, 12.985f, 15.739f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(12.528f, 17.356f, 12.5f, 17.675f, 12.5f, 18f)
                verticalLineTo(17.35f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(12.5f, 18f)
                curveTo(12.5f, 18.075f, 12.502f, 18.149f, 12.505f, 18.224f)
...
private var calendarBadgeExclamation: ImageVector? = null