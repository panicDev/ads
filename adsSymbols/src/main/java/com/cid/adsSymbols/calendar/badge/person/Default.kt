package com.cid.adsSymbols.calendar.badge.person
...
val IdsSymbols.Default.CalendarBadgePerson: ImageVector
    get() {
        if (calendarBadgePerson != null) {
            return calendarBadgePerson!!
        }
        calendarBadgePerson = ImageVector.Builder(
            name = "calendar-badge-person-default",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var calendarBadgePerson: ImageVector? = null
