package com.cid.adsSymbols.calendar.badge.plus
...
val IdsSymbols.Default.CalendarBadgePlus: ImageVector
    get() {
        if (calendarBadgePlus != null) {
            return calendarBadgePlus!!
        }
        calendarBadgePlus = ImageVector.Builder(
            name = "calendar-badge-plus-default",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var calendarBadgePlus: ImageVector? = null
