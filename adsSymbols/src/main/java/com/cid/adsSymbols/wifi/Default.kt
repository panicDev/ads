package com.cid.adsSymbols.wifi
...
val IdsSymbols.Default.Wifi: ImageVector
    get() {
        if (wifi != null) {
            return wifi!!
        }
        wifi = Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(8.201f, 4.002f, 4.766f, 5.575f, 2.285f, 8.11f)
                curveTo(1.899f, 8.504f, 1.906f, 9.137f, 2.3f, 9.524f)
                curveTo(2.695f, 9.91f, 3.328f, 9.903f, 3.715f, 9.509f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(11.998f, 10.002f)
                curveTo(9.848f, 10.002f, 7.9f, 10.89f, 6.483f, 12.337f)
                ...
                curveTo(16.097f, 10.89f, 14.148f, 10.002f, 11.998f, 10.002f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(9.25f, 15.167f)
                ...
                curveTo(8.231f, 15.568f, 8.864f, 15.561f, 9.25f, 15.167f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(11.998f, 20f)
                curveTo(13.079f, 20f, 13.956f, 19.105f, 13.956f, 18f)
                curveTo(13.956f, 16.896f, 13.079f, 16.001f, 11.998f, 16.001f)
                curveTo(10.917f, 16.001f, 10.04f, 16.896f, 10.04f, 18f)
