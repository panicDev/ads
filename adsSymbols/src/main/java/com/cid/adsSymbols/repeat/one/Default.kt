package com.cid.adsSymbols.repeat.one
...
val IdsSymbols.Default.Repeat1: ImageVector
    get() {
        if (repeat1 != null) {
            return repeat1!!
        }
        repeat1 = Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(17.474f, 8.014f, 18.095f, 8.139f, 18.555f, 7.832f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(5.905f, 22.139f, 6.526f, 22.014f, 6.832f, 21.555f)
