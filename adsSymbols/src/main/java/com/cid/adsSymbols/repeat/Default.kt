package com.cid.adsSymbols.repeat
...
val IdsSymbols.Default.Repeat: ImageVector
    get() {
        if (repeat != null) {
            return repeat!!
        }
        repeat = Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(18.095f, 8.139f, 17.474f, 8.014f, 17.168f, 7.555f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(6.526f, 22.014f, 5.905f, 22.139f, 5.445f, 21.832f)
