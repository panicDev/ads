package com.cid.adsSymbols.xmark
...
val IdsSymbols.Default.XMark: ImageVector
    get() {
        if (xMark != null) {
            return xMark!!
        }
        xMark = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(5.321f, 19.46f, 5.956f, 19.458f, 6.347f, 19.068f)
                lineTo(12f, 13.414f)
                lineTo(17.653f, 19.068f)
                ...
                curveTo(18.679f, 4.54f, 18.044f, 4.542f, 17.653f, 4.933f)
                lineTo(12f, 10.586f)
                lineTo(6.347f, 4.933f)
                curveTo(5.956f, 4.542f, 5.321f, 4.541f, 4.929f, 4.929f)
