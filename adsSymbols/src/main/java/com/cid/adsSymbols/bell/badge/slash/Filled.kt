    ...
    get() {
        ...
        bellBadgeSlash = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(13.707f, 3.202f, 14.372f, 3.444f, 14.972f, 3.787f)
                curveTo(14.518f, 4.407f, 14.25f, 5.172f, 14.25f, 6f)
                curveTo(14.25f, 8.071f, 15.929f, 9.75f, 18f, 9.75f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
