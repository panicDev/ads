package com.cid.adsSymbols.bell.badge
...
val IdsSymbols.Default.BellBadge: ImageVector
    get() {
        if (bellBadge != null) {
            return bellBadge!!
        }
        bellBadge = ImageVector.Builder(
            name = "bell-badge-default",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(17.265f, 9.75f, 16.579f, 9.538f, 16f, 9.172f)
                verticalLineTo(17f)
                horizontalLineTo(8f)
