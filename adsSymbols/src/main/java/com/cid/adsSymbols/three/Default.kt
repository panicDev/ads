package com.cid.adsSymbols.three
...
val IdsSymbols.Default.Three: ImageVector
    get() {
        if (three != null) {
            return three!!
        }
        three = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(16.284f, 7.917f, 16.166f, 8.514f, 15.937f, 8.97f)
                curveTo(15.698f, 9.444f, 15.301f, 9.837f, 14.826f, 10.157f)
                curveTo(14.353f, 10.476f, 13.842f, 10.695f, 13.439f, 10.835f)
                lineTo(12.802f, 11.02f)
                curveTo(12.336f, 11.114f, 12f, 11.524f, 12f, 12f)
                curveTo(12f, 12.476f, 12.336f, 12.887f, 12.803f, 12.981f)
                ...
                curveTo(9.296f, 2.5f, 6.981f, 4.15f, 6.001f, 6.495f)
