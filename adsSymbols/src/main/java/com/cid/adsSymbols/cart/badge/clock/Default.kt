package com.cid.adsSymbols.cart.badge.clock
...
val IdsSymbols.Default.CartBadgeClock: ImageVector
    get() {
        if (cartBadgeClock != null) {
            return cartBadgeClock!!
        }
        cartBadgeClock = ImageVector.Builder(
            name = "cart-badge-clock-default",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var cartBadgeClock: ImageVector? = null