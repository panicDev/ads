package com.cid.adsSymbols.cart.badge.minus
...
val IdsSymbols.Default.CartBadgeMinus: ImageVector
    get() {
        if (cartBadgeMinus != null) {
            return cartBadgeMinus!!
        }
        cartBadgeMinus = ImageVector.Builder(
            name = "cart-badge-minus-default",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(15.75f, 6f)
                curveTo(15.75f, 5.586f, 16.086f, 5.25f, 16.5f, 5.25f)
                horizontalLineTo(19.5f)
                curveTo(19.914f, 5.25f, 20.25f, 5.586f, 20.25f, 6f)
                curveTo(20.25f, 6.414f, 19.914f, 6.75f, 19.5f, 6.75f)
                horizontalLineTo(16.5f)
                curveTo(16.086f, 6.75f, 15.75f, 6.414f, 15.75f, 6f)
                close()
            }
            path(
...
private var cartBadgeMinus: ImageVector? = null