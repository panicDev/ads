package com.cid.adsSymbols.chart.donut.simple
...
val IdsSymbols.Default.ChartDonutSimple: ImageVector
    get() {
        ...
        chartDonutSimple = Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(10.853f, 2.463f, 10.317f, 2.125f, 9.779f, 2.248f)
                ...
                curveTo(20.46f, 12.902f, 19.924f, 13.24f, 19.802f, 13.779f)
                curveTo(18.993f, 17.341f, 15.806f, 20f, 12f, 20f)
                curveTo(7.582f, 20f, 4f, 16.418f, 4f, 12f)
                curveTo(4f, 8.194f, 6.659f, 5.006f, 10.221f, 4.198f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(14.221f, 2.248f)
                curveTo(13.683f, 2.125f, 13.147f, 2.463f, 13.025f, 3.002f)
                curveTo(12.903f, 3.54f, 13.24f, 4.076f, 13.779f, 4.198f)
                curveTo(16.768f, 4.876f, 19.124f, 7.232f, 19.802f, 10.221f)
