package com.cid.adsSymbols.user.badge.plus
...
val IdsSymbols.Default.UserBadgePlus: ImageVector
    get() {
        if (userBadgePlus != null) {
            return userBadgePlus!!
        }
        userBadgePlus = Builder(
            name = "user-badge-plus-default",
...
private var userBadgePlus: ImageVector? = null