package com.cid.adsSymbols.comment.plus
...
val IdsSymbols.Default.CommentPlus: ImageVector
    get() {
        if (commentPlus != null) {
            return commentPlus!!
        }
        commentPlus = Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(12.436f, 15.75f)
                curveTo(12.656f, 15.206f, 12.954f, 14.701f, 13.316f, 14.25f)
                horizontalLineTo(7f)
                curveTo(6.586f, 14.25f, 6.25f, 14.586f, 6.25f, 15f)
                curveTo(6.25f, 15.414f, 6.586f, 15.75f, 7f, 15.75f)
                horizontalLineTo(12.436f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(15.093f, 12.75f)
                curveTo(15.886f, 12.31f, 16.789f, 12.045f, 17.75f, 12.005f)
                lineTo(17.75f, 12f)
