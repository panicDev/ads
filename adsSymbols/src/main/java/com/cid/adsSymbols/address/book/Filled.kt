package com.cid.adsSymbols.address.book
...
val IdsSymbols.Filled.AddressBook: ImageVector
    get() {
        if (addressBook != null) {
            return addressBook!!
        }
        addressBook = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(3f, 6.4f)
                curveTo(3f, 3.97f, 4.97f, 2f, 7.4f, 2f)
                horizontalLineTo(14.6f)
                curveTo(17.03f, 2f, 19f, 3.97f, 19f, 6.4f)
                verticalLineTo(17.6f)
                curveTo(19f, 20.03f, 17.03f, 22f, 14.6f, 22f)
