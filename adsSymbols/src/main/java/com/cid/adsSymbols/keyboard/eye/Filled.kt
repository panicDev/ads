...
val IdsSymbols.Filled.KeyboardEye: ImageVector
    get() {
        if (keyboardEye != null) {
            return keyboardEye!!
        }
        keyboardEye = ImageVector.Builder(
            name = "keyboard-eye-filled",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                curveTo(10.612f, 19.067f, 10.621f, 17.918f, 11.275f, 16.971f)
                curveTo(11.504f, 16.64f, 11.786f, 16.31f, 12.124f, 16f)
                horizontalLineTo(8.5f)
                curveTo(8.224f, 16f, 8f, 15.776f, 8f, 15.5f)
                verticalLineTo(14.5f)
                curveTo(8f, 14.224f, 8.224f, 14f, 8.5f, 14f)
                horizontalLineTo(15.5f)
                curveTo(15.71f, 14f, 15.89f, 14.13f, 15.964f, 14.314f)
                curveTo(16.31f, 14.272f, 16.673f, 14.25f, 17.055f, 14.25f)
                lineTo(17.112f, 14.25f)
                curveTo(17.221f, 14.099f, 17.399f, 14f, 17.6f, 14f)
                horizontalLineTo(18.4f)
                curveTo(18.683f, 14f, 18.92f, 14.196f, 18.983f, 14.46f)
                curveTo(20.264f, 14.754f, 21.253f, 15.329f, 21.982f, 15.996f)
                curveTo(21.994f, 15.866f, 22f, 15.733f, 22f, 15.6f)
                verticalLineTo(8.4f)
