package com.cid.adsSymbols.keyboard.ellipsis
    ...
    get() {
        ...
        keyboardEllipsis = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(12.5f, 17.294f, 12.633f, 16.62f, 12.875f, 16f)
                horizontalLineTo(8.5f)
                curveTo(8.224f, 16f, 8f, 15.776f, 8f, 15.5f)
                verticalLineTo(14.5f)
                curveTo(8f, 14.224f, 8.224f, 14f, 8.5f, 14f)
                horizontalLineTo(14.225f)
                curveTo(14.987f, 13.281f, 15.954f, 12.777f, 17.029f, 12.585f)
                curveTo(17.01f, 12.527f, 17f, 12.465f, 17f, 12.4f)
                ...
                curveTo(19f, 12.465f, 18.99f, 12.527f, 18.971f, 12.585f)
                curveTo(20.155f, 12.796f, 21.208f, 13.386f, 22f, 14.225f)
                verticalLineTo(8.4f)
