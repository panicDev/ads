package com.cid.adsSymbols.chevron.left
...
val IdsSymbols.Default.ChevronLeft: ImageVector
    get() {
        if (chevronLeft != null) {
            return chevronLeft!!
        }
        chevronLeft = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(13.626f, 17.615f, 14.262f, 17.618f, 14.657f, 17.232f)
                curveTo(15.052f, 16.846f, 15.055f, 16.216f, 14.664f, 15.825f)
